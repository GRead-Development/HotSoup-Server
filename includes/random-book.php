<?php
/**
 * Random Book Selector - Core Functions
 *
 * Chunk 2.1: Core random book selection
 * LOC: ~80
 *
 * What this does:
 * - Selects a random unread book from user's library
 * - No database tables needed (uses existing data)
 *
 * API endpoint is in: includes/api/random-book-api.php
 */
 ...
 * @return array|false Book data or false if no unread books
 */
